...
Далее добавляем дополнитеольные строки в t и столбец pred с прогнозными знаечниями в фрейм с помощью функции **append** библиотеки pandas. Аргумент *ignote_index* означает будем ли мы игнорировать индексы таблицы, в данном случае будем, т.к. нам главное добавить в конец. Данные во во фрейм добавляются в виде словаря, чтобы python знал, что в какую колонку вставлять. 
